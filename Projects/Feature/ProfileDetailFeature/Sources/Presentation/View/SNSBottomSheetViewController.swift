...
// MARK: Configure
extension SNSBottomSheetViewController {
    ...
    private func configureLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            bottomSheetView.heightAnchor.constraint(equalToConstant: defaultHeight), // MARK: 이부분으로 인해 Layout 깨짐 경고가 뜬다

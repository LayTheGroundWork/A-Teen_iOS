...
public protocol TermsOfUseViewControllerCoordinator: AnyObject {
    func didFinish()
    func didSelectNextButton()
}

public final class TermsOfUseViewController: UIViewController {
    ...
    private func makeCustomCheckButton(tag: Int) -> UIButton {
        let button = UIButton()
        button.setImage(DesignSystemAsset.grayCheckButton.image, for: .normal)
        button.setImage(DesignSystemAsset.mainCheckButton.image, for: .selected)

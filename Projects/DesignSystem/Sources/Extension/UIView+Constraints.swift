...
extension UIView {
    ...
    public func fillSuperView(widthPadding: CGFloat = .zero) {
    ...
    public func centerXY() {
        centerX()
        centerY()
    }
    
    public func setHeightConstraint(with height: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
        heightAnchor.constraint(equalToConstant: height).isActive = true
    }
    
    public func setWidthConstraint(with width: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
...
extension UIView {
    public func recursiveUnionInDepthFor(view: UIView) -> CGRect {
